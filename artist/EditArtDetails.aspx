...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="1" style="border: black 2px solid;border-collapse:collapse; text-align:center;margin:0px auto;background-color:white;width:550px;">
        ...
        <tr >
            <td><asp:FileUpload ID="art_image_upload" runat="server" accept=".png,.jpg,.jpeg" /><br /><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="art_image_upload" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="upload" ErrorMessage="Please upload a photo!" CssClass="error" Font-Bold="True"></asp:RequiredFieldValidator><br />
        ...
        <tr>
            <td><asp:TextBox ID="art_qty" style="width:300px;box-sizing: border-box;text-align:center;" runat="server" MaxLength="4"></asp:TextBox><br /><asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="art_qty" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="upload" ErrorMessage="Please enter your art quantity!" Font-Bold="True"></asp:RequiredFieldValidator><br /><asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="Please enter integer for art quantity!" ControlToValidate="art_qty" CssClass="error" Display="Dynamic" Font-Bold="True" ForeColor="Red" ValidationExpression="\d+" SetFocusOnError="True" ValidationGroup="upload"></asp:RegularExpressionValidator><br /><asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="Please enter value between 1 and 1000 only." CssClass="error" Font-Bold="True" ForeColor="Red" MaximumValue="1000" MinimumValue="1" ValidationGroup="upload" Type="Integer" ControlToValidate="art_qty"></asp:RangeValidator></td>
        </tr>
        ...
        <tr>
            <td><asp:TextBox ID="art_description" style="box-sizing: border-box;overflow-wrap: break-word;resize:none" runat="server" Font-Size="14pt" Height="286px" TextMode="MultiLine" Width="415px"></asp:TextBox><br /><asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="art_description" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ValidationGroup="upload" ErrorMessage="Please enter your art description!" Font-Bold="True"></asp:RequiredFieldValidator></td>
        </tr>
    </table>
